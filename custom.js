...
function applyCustomActions(data) {
    ...
    var replyStream = [
        ...
        "Ofrece pizza gratis a todos, especialmente a DJTOTYGEE.",
    ...
    var replyLottery = [
      ...
      "No, no ganas la lotería... pero sí un abrazo gratis de DJTOTYGEE.",
      ...
      "Ja... Ganas la oportunidad de hacer la colada de DJTOTYGEE.",
      ...
      "Sí, pero solo si compras toda la mercancía de DJTOTYGEE, le das la mitad de tus ganancias y aceptas usar un sombrero divertido en tu próximo stream.",
 ...
 [
      "Puedes convertirte en el próximo jefe, solo si te haces suscriptor del canal de DJTOTYGEE, compras todos los artículos en su tienda y le das una buena donación con al menos 3 ceros.",
